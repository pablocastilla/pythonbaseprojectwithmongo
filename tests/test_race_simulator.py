...
class TestFaceSimulator:
    def test_simulate_with_mocker(self, mocker):
        ...
        mocker.patch('repositories.formula_one_repository.FormulaOneRepository.get_all', return_value = [formula_one.FormulaOne(car_number=44, driver_name='Lewis Hamilton'), formula_one.FormulaOne(car_number=14, driver_name='Fernando Alonso')])
